...
<head>
    ...
    <link rel="stylesheet" href="/PBL6-Dictionary/public/css/style_themPage.css">
</head>
<body>
    <div class="container">
        @for ($i = 0; $i < ceil(count($topics) / 4); $i++)
            ...
            <div class="wrapper">
                @foreach ($currentTopics as $topic)
                    <div class="card">
                        <img src="{{ url($topic['image_topic']) }}" alt="">
                        <div class="info">
                            ...
                            <a href="#" onclick="event.preventDefault(); window.location.href='{{ route('reviewVocaPage', ['username' => $username, 'id_topic' => $topic['id']]) }}'" class="btn">Review</a>
                        </div>
                    </div>
                @endforeach
            </div>
